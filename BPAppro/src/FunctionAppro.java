...
public class FunctionAppro implements LearningEventListener{
    ...
    public void run() throws IOException {
        ...
        MlPerceptron myMlPerceptron = new MlPerceptronLineOutput(1,8,1);
    ...
    public static void testNeuralNetwork(NeuralNetwork neuralNet) throws IOException {
    	...
    	FileUtils.writeStringToFile(new File("G:/x.txt"), x.toString());
    	FileUtils.writeStringToFile(new File("G:/y.txt"), y.toString());
    }
